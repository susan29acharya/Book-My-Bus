...
<body>
    ...
    <?php elseif ($ticketDetails): ?>
        <div class="print">
            ...
            <form method="post">
                <input type="hidden" name="cancel_ticket_number"
                    value="<?php echo htmlspecialchars($ticketDetails['ticketnumber']); ?>">
                <input type="hidden" name="cancel_date"
                    value="<?php echo htmlspecialchars($ticketDetails['mobilenumber']); ?>">
